...
<html>
  ...
  <body>
  	<div class="text-center">
  		...
  		<?php 
	  		$get_intervention_amount = mysql_query("select intervention_amount,date from history_offers where id='1'");
  	...
  	<div class="container">
  		<table class="table table-striped table-hover table-bordered text-center">
			...
			<?php
	  			...
	  			$get_rates = mysql_query("select distinct rate from offers where id_history = '1' order by rate desc");
				...
				while ($data = mysql_fetch_assoc($get_rates)) {
					...
					where rate = '$rate' and id_history = '1'");
